const BackgroundShadows = ({ isWordEntered }) => {
  return (
    <>
      <div
        className={`absolute overflow-hidden hidden md:block top-0 right-0 bg-img ${
      ...
      >
        ...
        >
          <g opacity="0.5" filter="url(#filter0_f_201_203)">
            <circle cx="790" cy="222" r="240" fill="#0500FF" />
          </g>
          <defs>
            <filter
      ...
      <div
        className={`absolute overflow-hidden hidden md:block top-0 left-0 bg-img ${
          isWordEntered ? "h-full" : "h-[60rem]"
        }`}
      >
        <svg
        ...
        >
          <g opacity="0.5" filter="url(#filter0_f_201_218)">
            <circle cx="134.5" cy="388.5" r="250.5" fill="#0500FF" />
          </g>
          <defs>
            <filter
